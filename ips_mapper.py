...
if __name__ == "__main__":
    ...
    #
    # CIDR IP addresses consist of two groups of numbers
    # The most important of these groups is the network address, and it is used to identify
    # a network or a sub-network (subnet). The lesser of the bit groups is the host identifier.
    # The host identifier is used to determine which host or device on the network
